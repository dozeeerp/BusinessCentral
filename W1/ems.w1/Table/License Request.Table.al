table 52101 "License Request"
{
    ...
    begin
        ...
        if LICToCustomerIsReplaced() or
            ShouldCopyAddressFromLICToCustomer(LICToCustomer) or
    ...
    local procedure ShouldCopyAddressFromLICToCustomer(SellToCustomer: Record Customer): Boolean
    begin
        exit((not HasLICToAddress) and SellToCustomer.HasAddress);
    end;
    ...
    procedure HasLICToAddress(): Boolean
    begin
        case true of
            "Address" <> '':
                exit(true);
