namespace TSTChanges.Warehouse;
...
codeunit 51234 "TST WMS Management"
{
    ...
    procedure CreateWhseJnlLine(ItemJnlLine: Record "FA Item Journal Line"; ItemJnlTemplateType: Option; var WhseJnlLine: Record "Warehouse Journal Line"; ToTransfer: Boolean): Boolean
    //     var
    //         IsHandled: Boolean;
    begin
        //         IsHandled := false;
    ...
    procedure CheckItemJnlLineFieldChange(ItemJnlLine: Record "FA Item Journal Line"; xItemJnlLine: Record "FA Item Journal Line"; CurrFieldCaption: Text[30])
    var
        BinContent: Record "Bin Content";
    ...
    begin
        ...
        if ItemJnlLine."Entry Type" in
           [ItemJnlLine."Entry Type"::"Negative Adjmt.", ItemJnlLine."Entry Type"::"Positive Adjmt."]//, "Entry Type"::Sale, "Entry Type"::Purchase]
        then begin
            ...
            if ((ItemJnlLine."FA Item No." <> xItemJnlLine."FA Item No.") and (xItemJnlLine."FA Item No." <> '')) or
            ...
            if Location."Bin Capacity Policy" <> Location."Bin Capacity Policy"::"Never Check Capacity" then begin
                if ItemJnlLine."Bin Code" <> '' then begin
                    // CalcCubageAndWeight(ItemJnlLine."FA Item No.", ItemJnlLine."Unit of Measure Code", ItemJnlLine.Quantity, Cubage, Weight);
                    if BinContent.Get(Location.Code, ItemJnlLine."Bin Code", ItemJnlLine."FA Item No.", ItemJnlLine."Variant Code", ItemJnlLine."Unit of Measure Code") then
                        ...
                        Bin.CheckIncreaseBin(Bin.Code, ItemJnlLine."FA Item No.", ItemJnlLine.Quantity, 0, 0, Cubage, Weight, false, false);
                    end;
                end
            end else
                CheckWarehouseClass(Location.Code, ItemJnlLine."Bin Code", ItemJnlLine."FA Item No.", ItemJnlLine."Variant Code", ItemJnlLine."Unit of Measure Code");
        end;
        // end;
    end;
    ...
    procedure CheckItemTrackingChange(TrackingSpecification: Record "FA Tracking Specification"; xTrackingSpecification: Record "FA Tracking Specification")
    //     var
    //         IsHandled: Boolean;
    begin
        //         IsHandled := false;
        ...
        if (TrackingSpecification."Source Type" = Database::"FA Item Journal Line") and
           (TrackingSpecification."Item No." <> '') and
           (TrackingSpecification."Location Code" <> '')
        then begin
            // if "Source Subtype" in [0, 1, 2, 3] then //Purchase,Sales,Positive Adjmt, Negative Adjmt
            if TrackingSpecification."Source Type" in [3, 4] then //Negative Adjmt, Positive Adjmt
    ...
    local procedure CheckTrackingSpecificationChangeNeeded(TrackingSpecification: Record "FA Tracking Specification"; xTrackingSpecification: Record "FA Tracking Specification") CheckNeeded: Boolean
    begin
        CheckNeeded :=
    ...
    procedure SetTransferLine(FATransferLine: Record "FA Transfer Line"; var WarehouseJournalLine: Record "Warehouse Journal Line"; PostingType: Option Shipment,Receipt; PostedDocNo: Code[20])
    begin
        // with FATransferLine do begin
        WarehouseJournalLine.SetSource(Database::"FA Transfer Line", PostingType, FATransferLine."Document No.", FATransferLine."Line No.", 0);
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterCheckTrackingSpecificationChangeNeeded(TrackingSpecification: Record "FA Tracking Specification"; xTrackingSpecification: Record "FA Tracking Specification"; var CheckNeeded: Boolean)
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnGetItemOnAfterGetItem(var Item: Record "FA Item")
    begin
    end;
