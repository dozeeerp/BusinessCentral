...
page 51226 "Posted FA Trans Shpt. Subform"
{
    Caption = 'Lines';
    Editable = false;
    LinksAllowed = false;
    PageType = ListPart;
    SourceTable = "FA Transfer Shipment Line";
    ...
    var
        TransferShptLine: Record "FA Transfer Shipment Line";
    begin
        TransferShptLine.Copy(Rec);
        CurrPage.SetSelectionFilter(TransferShptLine);
        CODEUNIT.Run(CODEUNIT::"Undo FA Transfer Shipment", TransferShptLine);
    end;
