...
page 51227 "Posted FA Transfer Receipts"
{
    ApplicationArea = Location;
    Caption = 'Posted FA Transfer Receipts';
    CardPageID = "Posted FA Transfer Receipt";
    Editable = false;
    PageType = List;
    ...
    layout
    {
        area(Content)
        {
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Location;
                    ToolTip = 'Specifies the code of the customer that items are transferred from.';
                }
                ...
                {
                    ApplicationArea = Location;
                    ToolTip = 'Specified the code of the customer that the items are transferred to.';
                }
