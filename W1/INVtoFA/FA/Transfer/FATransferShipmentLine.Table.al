...
table 51217 "FA Transfer Shipment Line"
{
    Caption = 'FA Transfer Shipment Line';
    // LookupPageID = "FA Posted Transfer Shipment Lines";
    ...
    fields
    {
        ...
        field(40; "Correction Line"; Boolean)
        {
            Caption = 'Correction';
            Editable = false;
        }
    ...
    keys
    {
        ...
        key(Key2; "Transfer Order No.", "FA Item No.", "Shipment Date")
        {
        }
    }
    ...
    begin
        ItemTrackingDocMgt.ShowItemTrackingForShptRcptLine(DATABASE::"FA Transfer Shipment Line", 0, "Document No.", '', 0, "Line No.");
    end;

    procedure CopyFromTransferLine(TransLine: Record "FA Transfer Line")
    begin
        "Line No." := TransLine."Line No.";
        "Trans. Order Line No." := TransLine."Line No.";
        "FA Item No." := TransLine."FA Item No.";
        ...
        "Transfer-from Customer" := TransLine."Transfer-from Customer";
        "Transfer-to Customer" := TransLine."Transfer-to Customer";
    ...
    local procedure OnAfterCopyFromTransferLine(var TransferShipmentLine: Record "FA Transfer Shipment Line"; TransferLine: Record "FA Transfer Line")
    begin
    end;
}