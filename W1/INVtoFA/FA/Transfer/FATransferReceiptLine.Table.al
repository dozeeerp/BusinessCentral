...
table 51219 "FA Transfer Receipt Line"
{
    DataClassification = CustomerContent;
    Caption = 'FA Transfer Receipt Line';
    ...
    begin
        ItemTrackingDocMgt.ShowItemTrackingForShptRcptLine(DATABASE::"FA Transfer Receipt Line", 0, "Document No.", '', 0, "Line No.");
    end;

    procedure CopyFromTransferLine(TransLine: Record "FA Transfer Line")
    begin
        "Line No." := TransLine."Line No.";
        "Item No." := TransLine."FA Item No.";
    ...
    local procedure OnAfterCopyFromTransferLine(var TransferReceiptLine: Record "FA Transfer Receipt Line"; TransferLine: Record "FA Transfer Line")
    begin
    end;
}