...
table 51222 "FA Direct Trans. Header"
{
    ...
    var
        ...
        DirectTransLine: Record "FA Direct Trans. Line";
    ...
    begin
        ...
        ItemTrackingMgt.DeleteItemEntryRelation(DATABASE::"FA Direct Trans. Line", 0, "No.", '', 0, 0, true);

        // MoveEntries.MoveDocRelatedEntries(DATABASE::"FA Direct Trans. Header", "No.");
    end;
