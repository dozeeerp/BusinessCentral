...
page 51221 "FA Item Units of Measure"
{
    Caption = 'FA Item Units of Measure';
    DataCaptionFields = "Item No.";
    PageType = List;
    PopulateAllFields = true;
    SourceTable = "FA Item Unit of Measure";
    ...
    var
        Item: Record "FA Item";
        ItemBaseUnitOfMeasure: Record "FA Item Unit of Measure";
    ...
    local procedure OnAfterSetStyle(var StyleName: Text; ItemBaseUOM: Code[10]; Item: Record "FA Item")
    begin
    end;
}