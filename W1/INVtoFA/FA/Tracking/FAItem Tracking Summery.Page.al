...
page 51210 "FA Item Tracking Summary"
{
    Caption = 'FA Item Tracking Summary';
    DeleteAllowed = false;
    InsertAllowed = false;
    PageType = Worksheet;
    ...
    procedure SetSources(var ReservEntry: Record "FA Reservation Entry"; var EntrySummary: Record "Entry Summary")
    var
                ...
                begin
                    ...
                    if TempReservationEntry.FindSet() then
                        repeat
                            ...
                            if TempReservationEntry."Source Type" = DATABASE::"FA Item ledger Entry" then begin
                    ...
                    PAGE.RunModal(PAGE::"Avail. FA Item Tracking Lines", TempReservEntry2);
                end;
            Rec.FieldNo("Total Requested Quantity"):
                begin
                    TempReservationEntry.SetRange(Positive, false);
                    TempReservationEntry.Ascending(false);
                    PAGE.RunModal(PAGE::"Avail. FA Item Tracking Lines", TempReservationEntry);
                end;
        end;
