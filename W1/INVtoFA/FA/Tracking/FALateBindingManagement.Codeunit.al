...
codeunit 51221 "FA Late Binding Management"
{
    ...
    var
        TempCurrSupplyReservEntry: Record "FA Reservation Entry" temporary;
        TempCurrDemandReservEntry: Record "FA Reservation Entry" temporary;
        TempSupplyReservEntry: Record "FA Reservation Entry" temporary;
        TempReservEntryDelete: Record "FA Reservation Entry" temporary;
        TempReservEntryModify: Record "FA Reservation Entry" temporary;
        TempReservEntryInsert: Record "FA Reservation Entry" temporary;
        TempReservEntryOrderTrackingSurplus: Record "FA Reservation Entry" temporary;
    ...
    procedure ReallocateTrkgSpecification(var TempTrackingSpecification: Record "FA Tracking Specification" temporary)
    begin
    ...
    local procedure Reallocate(var TempTrackingSpecification: Record "FA Tracking Specification" temporary) AllocationsChanged: Boolean
    var
    ...
    local procedure PrepareTempDataSet(var TempTrackingSpecification: Record "FA Tracking Specification" temporary; QtyToPrepare: Decimal): Boolean
    var
    ...
    begin
        ...
        ItemLedgEntry.SetCurrentKey("FA Item No.", Open, "Variant Code", Positive, "Location Code");
    ...
    local procedure ReshuffleReservEntry(SupplyReservEntry: Record "FA Reservation Entry"; QtyToReshuffle: Decimal; var TempTrackingSpecification: Record "FA Tracking Specification" temporary) RemainingQty: Decimal
    var
    ...
    local procedure MakeConnection(var SupplySurplusEntry: Record "FA Reservation Entry"; var DemandReservEntry: Record "FA Reservation Entry"; QtyToReshuffle: Decimal) RemainingQty: Decimal
    var
        NewEntryNo: Integer;
        IsHandled: Boolean;
    begin
    ...
    local procedure CalcInventory(var TempTrackingSpecification: Record "FA Tracking Specification" temporary): Boolean
    var
        ItemLedgEntry: Record "FA Item Ledger Entry";
        ReservEntry: Record "FA Reservation Entry";
    ...
    begin
        ...
        ReservEntry.SetRange("Source Type", DATABASE::"FA Item Ledger Entry");
    ...
    local procedure CalcAllocations(var TempTrackingSpecification: Record "FA Tracking Specification" temporary): Boolean
    var
        ReservEntry: Record "FA Reservation Entry";
    ...
    begin
        ...
        ReservEntry.SetRange("Variant Code", TempTrackingSpecification."Variant Code");
        ReservEntry.SetRange("Location Code", TempTrackingSpecification."Location Code");
        ReservEntry.SetRange("Source Type", DATABASE::"FA Item Ledger Entry"); // (ILE)
        ReservEntry.SetRange("Source Subtype", 0);
    ...
    local procedure InsertTempSupplyReservEntry(ItemLedgEntry: Record "FA Item Ledger Entry")
    var
        IsHandled: Boolean;
    begin
        IsHandled := false;
        ...
        if not IsHandled then begin
            ...
            TempSupplyReservEntry."Source Type" := DATABASE::"FA Item Ledger Entry";
            TempSupplyReservEntry."Source Ref. No." := ItemLedgEntry."Entry No.";
            TempSupplyReservEntry."Item No." := ItemLedgEntry."FA Item No.";
    ...
    procedure NonspecificReservedQty(var ItemLedgEntry: Record "FA Item Ledger Entry") UnspecificQty: Decimal
    var
        ReservEntry: Record "FA Reservation Entry";
        ReservEntry2: Record "FA Reservation Entry";
    begin
        ...
        ReservEntry.SetCurrentKey("Item No.", "Source Type", "Source Subtype", "Reservation Status", "Location Code", "Variant Code");
        ReservEntry.SetRange("Item No.", ItemLedgEntry."FA Item No.");
    ...
    procedure NonSpecificReservedQtyExceptForSource(ItemLedgerEntryNo: Integer; TempTrackingSpecification: Record "FA Tracking Specification" temporary) UnspecificQty: Decimal
    var
        ItemLedgerEntry: Record "FA Item Ledger Entry";
        ReservEntry: Record "FA Reservation Entry";
        OppositeReservEntry: Record "FA Reservation Entry";
        ItemLedgerEntryReserve: Codeunit "FA Item Ledger Entry-Reserve";
    begin
        UnspecificQty := 0;
    ...
    procedure ReleaseForReservation(var CalcItemLedgEntry: Record "FA Item Ledger Entry"; CalcReservEntry: Record "FA Reservation Entry"; RemainingQtyToReserve: Decimal) AllocationsChanged: Boolean
    var
    ...
    begin
        ...
        if AvailableToReserve < RemainingQtyToReserve then begin
            ItemTrackingSetup.CopyTrackingFromFAReservEntry(CalcReservEntry);
            AllocationsChanged :=
    ...
    procedure ReserveItemTrackingLine(TrackingSpecification: Record "FA Tracking Specification")
    var
        ReservEntry: Record "FA Reservation Entry";
    ...
    procedure ReserveItemTrackingLine(TrackingSpecification: Record "FA Tracking Specification"; QtyToReserve: Decimal; QtyToReserveBase: Decimal)
    var
        ReservEntry: Record "FA Reservation Entry";
        AvailabilityDate: Date;
    begin
    ...
    local procedure GetReservEntriesForItemLedgEntry(var TempReservationEntry: Record "FA Reservation Entry" temporary; ItemLedgEntryNo: Integer)
    var
        ReservationEntry: Record "FA Reservation Entry";
    begin
        TempReservationEntry.DeleteAll();

        ReservationEntry.SetSourceFilter(DATABASE::"FA Item Ledger Entry", 0, '', ItemLedgEntryNo, true);
    ...
    begin
        ...
        TempReservEntryOrderTrackingSurplus.SetSourceFilter(DATABASE::"FA Item Ledger Entry", 0, '', ItemLedgEntryNo, true);
    ...
    local procedure OnBeforeTempSupplyReservEntryInsert(var ReservationEntry: Record "FA Reservation Entry"; ItemLedgerEntry: Record "FA Item Ledger Entry")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnReserveItemTrackingLineOnBeforeAutoReserveOneLine(var ReservationEntry: Record "FA Reservation Entry")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnPrepareTempDataSetOnAfterItemLedgEntrySetFilters(var ItemLedgEntry: Record "FA Item Ledger Entry"; var TempTrackingSpecification: Record "FA Tracking Specification")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeInsertTempSupplyReservEntry(var TempSupplyReservEntry: Record "FA Reservation Entry" temporary; ItemLedgEntry: Record "FA Item Ledger Entry"; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnMakeConnectionOnBeforeTempReservEntryModifyInsert(var TempReservEntryModify: Record "FA Reservation Entry" temporary; SupplySurplusEntry: Record "FA Reservation Entry"; QtyToReshuffle: Decimal; var IsHandled: Boolean)
    begin
    end;
}