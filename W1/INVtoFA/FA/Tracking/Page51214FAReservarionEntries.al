...
page 51214 "FA Reservation Entries"
{
    Caption = 'FA Reservation Entries';
    ...
    procedure LookupReserved(ReservationEntry: Record "FA Reservation Entry")
    begin
    ...
    local procedure OnAfterLookupReserved(var ReservEntry: Record "FA Reservation Entry")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeOnModifyRecord(var ReservEntry: Record "FA Reservation Entry"; xReservEntry: Record "FA Reservation Entry"; var Result: Boolean; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnCancelReservationOnBeforeConfirm(var ReservEntry: Record "FA Reservation Entry")
    begin
    end;
}