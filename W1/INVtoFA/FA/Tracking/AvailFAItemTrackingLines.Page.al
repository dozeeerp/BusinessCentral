...
page 51222 "Avail. FA Item Tracking Lines"
{
    Caption = 'Avail. FA Item Tracking Lines';
    ...
    ModifyAllowed = false;
    PageType = List;
    Permissions = TableData "FA Reservation Entry" = rm;
    SourceTable = "FA Reservation Entry";
    ...
    procedure SetReservSource(CurrentSourceRecRef: RecordRef; CurrentReservEntry: Record "FA Reservation Entry")
    var
    ...
    procedure SetReservSource(CurrentSourceRecRef: RecordRef; CurrentReservEntry: Record "FA Reservation Entry"; Direction: Enum "Transfer Direction")
    begin
        Clear(ReservMgt);
    ...
    procedure SetItemTrackingLine(LookupType: Integer; LookupSubtype: Integer; CurrentReservEntry: Record "FA Reservation Entry"; SearchForSupply: Boolean; AvailabilityDate: Date)
    begin
    ...
    local procedure OnAfterUpdateReservFrom(var ReservationEntry: Record "FA Reservation Entry")
    begin
    end;
}