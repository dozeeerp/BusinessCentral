...
table 51210 "FA Tracking Specification"
{
    Caption = 'FA Tracking Specification';
    ...
    fields
    {
        ...
        field(38; "Appl.-to Item Entry"; Integer)
        {
            ...
            begin
                ...
                ItemLedgEntry.SetRange("FA Item No.", "Item No.");
                ItemLedgEntry.SetRange(Positive, true);
                ItemLedgEntry.SetRange("Location Code", "Location Code");
                ItemLedgEntry.SetRange("Variant Code", "Variant Code");
                ItemLedgEntry.SetTrackingFilterFromSpec(Rec);
                ItemLedgEntry.SetRange(Open, true);
                if PAGE.RunModal(PAGE::"FA Item Ledger Entries", ItemLedgEntry) = ACTION::LookupOK then
        ...
        field(5811; "Appl.-from Item Entry"; Integer)
        {
            ...
            var
                ItemLedgEntry: Record "FA Item Ledger Entry";
            begin
                ItemLedgEntry.SetCurrentKey("FA Item No.", Positive, "Location Code", "Variant Code");
                ItemLedgEntry.SetRange("FA Item No.", "Item No.");
            ...
            begin
                ...
                ItemLedgEntry.TestField("FA Item No.", "Item No.");
...
#pragma warning restore AS0009
    ...
    procedure InitFromConHeader(var ConHeader: Record "FA Conversion Header")
    begin
        Init();
        SetItemData(
            ConHeader."FA Item No.", ConHeader.Description, ConHeader."Location Code", ConHeader."Variant Code", ConHeader."Bin Code",
            ConHeader."Qty. per Unit of Measure", ConHeader."Qty. Rounding Precision (Base)");
        SetSource(
            Database::"FA Conversion Header", 0//ConHeader."Document Type".AsInteger()
                        , ConHeader."No.", 0, '', 0);
        SetQuantities(
            ConHeader."Quantity (Base)", ConHeader."Quantity to Convert", ConHeader."Quantity to Convert (Base)",
            ConHeader."Quantity to Convert", ConHeader."Quantity to Convert (Base)",
            ConHeader."Converted Quantity (Base)", ConHeader."Converted Quantity (Base)");

        // OnAfterInitFromAsmHeader(Rec, ConHeader);
    end;
    ...
    procedure InitFromTransLine(var TransLine: Record "FA Transfer Line"; var AvalabilityDate: Date; Direction: Enum "Transfer Direction")
    begin
        case Direction of
            Direction::Outbound:
                begin
                    Init();
                    SetItemData(
                      TransLine."FA Item No.", TransLine.Description, TransLine."Transfer-from Code", TransLine."Variant Code",
                      TransLine."Transfer-from Bin Code", TransLine."Qty. per Unit of Measure", TransLine."Qty. Rounding Precision (Base)");
                    SetSource(
                      Database::"FA Transfer Line", Direction.AsInteger(), TransLine."Document No.", TransLine."Line No.", '',
            ...
            Direction::Inbound:
                begin
                    Init();
                    SetItemData(
                      TransLine."FA Item No.", TransLine.Description, TransLine."Transfer-to Code", TransLine."Variant Code",
    ...
    begin
        ...
        case "Source Type" of
            ...
            Database::"FA Item Journal Line":
                if ("Source Type" in [1, 3]) and ("Quantity (Base)" > 0)
                then
                    FieldError("Quantity (Base)");
    ...
    procedure CopySpecification(var TempTrackingSpecification: Record "FA Tracking Specification" temporary)
    begin
        Reset();
    ...
    procedure HasSameTracking(TrackingSpecification: Record "FA Tracking Specification") IsSameTracking: Boolean;
    begin
        IsSameTracking :=
    ...
    begin
        ...
        if IsReclass() then begin
            ...
            ItemTrackingSetup.CopyTrackingFromNewFATrackingSpec(Rec);
    ...
    begin
        Reclass := ("Source Type" = Database::"FA Item Journal Line") and ("Source Subtype" = 1);

        //         OnAfterIsReclass(Rec, Reclass);
    end;

    local procedure TestApplyToItemLedgEntryNo(ItemLedgEntry: Record "FA Item Ledger Entry")
    var
    ...
    begin
        ...
        ItemLedgEntry.TestField("Variant Code", "Variant Code");
        ItemLedgEntry.TestTrackingEqualToTrackingSpec(Rec);
        // if "Source Type" = Database::"FA Item Journal Line" then begin
        //     FAItemJnlLine.SetRange("Journal Template Name", "Source ID");
        //     FAItemJnlLine.SetRange("Journal Batch Name", "Source Batch Name");
        //     FAItemJnlLine.SetRange("Line No.", "Source Ref. No.");
        //     FAItemJnlLine.SetRange("Entry Type", "Source Subtype");
        //     if FAItemJnlLine.FindFirst() then
        //         if FAItemJnlLine."Entry Type" = FAItemJnlLine."Entry Type"::Output then begin
    ...
    procedure SetSourceFromReservEntry(ReservEntry: Record "FA Reservation Entry")
    begin
    ...
    procedure CopyTrackingFromTrackingSpec(TrackingSpecification: Record "FA Tracking Specification")
    begin
    ...
    procedure CopyNewTrackingFromTrackingSpec(TrackingSpecification: Record "FA Tracking Specification")
    begin
    ...
    procedure CopyNewTrackingFromNewTrackingSpec(TrackingSpecification: Record "FA Tracking Specification")
    begin
    ...
    procedure CopyTrackingFromItemLedgEntry(ItemLedgerEntry: Record "FA Item Ledger Entry")
    begin
    ...
    procedure CopyTrackingFromReservEntry(ReservEntry: Record "FA Reservation Entry")
    begin
    ...
    procedure SetTrackingFilterFromItemJnlLine(ItemJnlLine: Record "FA Item Journal Line")
    begin
    ...
    procedure SetTrackingFilterFromReservEntry(ReservEntry: Record "FA Reservation Entry")
    begin
    ...
    procedure SetNewTrackingFilterFromNewReservEntry(ReservEntry: Record "FA Reservation Entry")
    begin
    ...
    procedure SetNewTrackingFilterFromNewTrackingSpec(TrackingSpecification: Record "FA Tracking Specification")
    begin
    ...
    procedure SetNonSerialTrackingFilterFromSpec(TrackingSpecification: Record "FA Tracking Specification")
    begin
        SetRange("Lot No.", TrackingSpecification."Lot No.");
    ...
    procedure CheckItemTrackingByType(var ReservationEntry: Record "FA Reservation Entry"; QtyToHandleBase: Decimal; QtyToInvoiceBase: Decimal; OnlyLot: Boolean; Handle: Boolean; Invoice: Boolean)
    var
        TrackingSpecification: Record "FA Tracking Specification";
    ...
    local procedure GetUndefinedLots(var ReservationEntry: Record "FA Reservation Entry"; Handle: Boolean; Invoice: Boolean; var LotsToHandleUndefined: Boolean; var LotsToInvoiceUndefined: Boolean)
    var
        HandleLotNo: Code[50];
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterInitFromTransLine(var FATrackingSpecification: Record "FA Tracking Specification"; FATransferLine: Record "FA Transfer Line"; Direction: Enum "Transfer Direction")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnCheckPackageNo(TrackingSpecification: Record "FA Tracking Specification"; PackageNo: Code[50])
    begin
    end;
