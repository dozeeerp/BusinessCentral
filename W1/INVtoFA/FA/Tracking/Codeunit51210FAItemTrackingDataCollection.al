...
codeunit 51210 "FAItemTracking Data Collection"
{
    ...
    var
        TempGlobalReservEntry: Record "FA Reservation Entry" temporary;
        TempGlobalAdjustEntry: Record "FA Reservation Entry" temporary;
        ...
        TempGlobalTrackingSpec: Record "FA Tracking Specification" temporary;
        CurrBinCode: Code[20];
    ...
    local procedure InitItemTrackingSummaryForm(var ItemTrackingSummaryForm: Page "FA Item Tracking Summary"; var TempTrackingSpecification: Record "FA Tracking Specification" temporary; SearchForSupply: Boolean; CurrentSignFactor: Integer; LookupMode: Enum "Item Tracking Type"; MaxQuantity: Decimal)
    var
        Window: Dialog;
    begin
        Window.Open(Text004);
    ...
    local procedure CalculateQtyAfterEditingTrackingLine(var TempTrackingSpecification: Record "FA Tracking Specification" temporary; CurrentSignFactor: Integer; LookupMode: Enum "Item Tracking Type"; MaxQuantity: Decimal)
    var
    ...
    procedure AssistEditTrackingNo(var TempTrackingSpecification: Record "FA Tracking Specification" temporary; SearchForSupply: Boolean; CurrentSignFactor: Integer; LookupMode: Enum "Item Tracking Type"; MaxQuantity: Decimal)
    var
        ItemTrackingSummaryForm: Page "FA Item Tracking Summary";
    begin
    ...
    procedure AssistOutBoundBarcodeScannerTrackingNo(BarcodeResult: Text; var TempTrackingSpecification: Record "FA Tracking Specification" temporary; SearchForSupply: Boolean; CurrentSignFactor: Integer; LookupMode: Enum "Item Tracking Type"; MaxQuantity: Decimal): Boolean
    var
        ItemTrackingSummaryForm: Page "FA Item Tracking Summary";
    begin
    ...
    local procedure CalcNewQtyOnLine(var TempTrackingSpecification: Record "FA Tracking Specification" temporary; QtyOnLine: Decimal; AdjustmentQty: Decimal; QtyHandledOnLine: Decimal) NewQtyOnLine: Decimal
    var
        IsHandled: Boolean;
    begin
        IsHandled := false;
    ...
    local procedure AssistEditTrackingNoLookupSerialNo(TempTrackingSpecification: Record "FA Tracking Specification" temporary; var ItemTrackingSummaryPage: Page "FA Item Tracking Summary")
    begin
    ...
    local procedure AssistEditTrackingNoLookupLotNo(TempTrackingSpecification: Record "FA Tracking Specification" temporary; var ItemTrackingSummaryPage: Page "FA Item Tracking Summary")
    begin
        if TempTrackingSpecification."Serial No." <> '' then
            TempGlobalEntrySummary.SetRange("Serial No.", TempTrackingSpecification."Serial No.")
        else
    ...
    procedure SelectMultipleTrackingNo(var TempTrackingSpecification: Record "FA Tracking Specification" temporary; MaxQuantity: Decimal; CurrentSignFactor: Integer)
    var
    ...
    procedure LookupTrackingAvailability(var TempTrackingSpecification: Record "FA Tracking Specification" temporary; LookupMode: Enum "Item Tracking Type")
    var
        ItemTrackingSummaryForm: Page "FA Item Tracking Summary";
        Window: Dialog;
    begin
    ...
    local procedure ShouldExitLookupTrackingAvailability(TempTrackingSpecification: Record "FA Tracking Specification" temporary; LookupMode: Enum "Item Tracking Type"): Boolean
    var
        ShouldExit: Boolean;
    begin
        case LookupMode of
    ...
    local procedure RetrieveLookupData(var TempTrackingSpecification: Record "FA Tracking Specification" temporary; FullDataSet: Boolean; ReservEntryReadIsolation: IsolationLevel)
    var
    ...
    begin
        ...
        ItemLedgEntry.Reset();
        ItemLedgEntry.SetCurrentKey("FA Item No.", Open, "Variant Code", Positive, "Location Code", "Posting Date");
        ItemLedgEntry.SetRange("FA Item No.", TempTrackingSpecification."Item No.");
        ...
        //check if FA is to be taken from demo location
        If (TempTrackingSpecification."Source Type" = Database::"FA Transfer Line") and (TempTrackingSpecification."Source Subtype" = 0) then begin
            FATransferHeader.Reset();
            FATransferHeader.Get(TempTrackingSpecification."Source ID");
            if FATransferHeader."Transfer-from Customer" <> '' then
                ItemLedgEntry.SetRange("Customer No.", FATransferHeader."Transfer-from Customer");
        end;
    ...
    procedure RetrieveLookupData(var TempTrackingSpecification: Record "FA Tracking Specification" temporary; FullDataSet: Boolean)
    begin
    ...
    procedure TransferItemLedgToTempRec(var ItemLedgEntry: Record "FA Item Ledger Entry"; var TrackingSpecification: Record "FA Tracking Specification" temporary)
    var
        IsHandled: Boolean;
    begin
        ItemLedgEntry.SetLoadFields(
          "Entry No.", "FA Item No.", "Variant Code", Positive, "Location Code", "Serial No.", "Lot No.", "Package No.",
        ...
        if ItemLedgEntry.FindSet() then
            repeat
                ...
                then begin
                    ...
                    TempGlobalReservEntry."Item No." := ItemLedgEntry."FA Item No.";
                    ...
                    TempGlobalReservEntry."Source Type" := Database::"FA Item Ledger Entry";
    ...
    procedure TransferReservEntryToTempRec(var TempReservEntry: Record "FA Reservation Entry" temporary; var TrackingSpecification: Record "FA Tracking Specification" temporary)
    var
        IsHandled: Boolean;
    begin
    ...
    local procedure CreateEntrySummary(TrackingSpecification: Record "FA Tracking Specification" temporary; TempReservEntry: Record "FA Reservation Entry" temporary)
    begin
    ...
    local procedure CreateEntrySummary2(TempTrackingSpecification: Record "FA Tracking Specification" temporary; TempReservEntry: Record "FA Reservation Entry" temporary; SerialNoLookup: Boolean)
    var
        LateBindingManagement: Codeunit "FA Late Binding Management";
        DoInsert: Boolean;
    begin
        ...
        if SerialNoLookup then begin
            ...
            TempGlobalEntrySummary.SetTrackingFilterFromFAReservEntry(TempReservEntry);
        end else begin
            if not TempReservEntry.NonSerialTrackingExists() then
                exit;

            TempGlobalEntrySummary.SetRange("Serial No.", '');
            TempGlobalEntrySummary.SetNonSerialTrackingFilterFromFAReservEntry(TempReservEntry);
            if TempReservEntry."Serial No." <> '' then
    ...
    procedure AddSelectedTrackingToDataSet(var TempEntrySummary: Record "Entry Summary" temporary; var TempTrackingSpecification: Record "FA Tracking Specification" temporary; CurrentSignFactor: Integer)
    var
        TrackingSpecification2: Record "FA Tracking Specification";
        LastEntryNo: Integer;
    ...
    procedure TrackingAvailable(TempTrackingSpecification: Record "FA Tracking Specification" temporary; LookupMode: Enum "Item Tracking Type"): Boolean
    var
    ...
    begin
        ...
        ItemTrackingSetup.CopyTrackingFromFATrackingSpec(TempTrackingSpecification);
    ...
    procedure CheckAvailableTrackingQuantity(var TempTrackingSpecification: Record "FA Tracking Specification" temporary): Boolean
    var
        ItemTrackingSetup: Record "Item Tracking Setup";
    begin
    ...
    procedure UpdateTrackingDataSetWithChange(var TempTrackingSpecificationChanged: Record "FA Tracking Specification" temporary; LineIsDemand: Boolean; CurrentSignFactor: Integer; ChangeType: Option Insert,Modify,Delete)
    var
        LastEntryNo: Integer;
    begin
    ...
    local procedure UpdateTrackingGlobalChangeRec(var TempTrackingSpecificationChanged: Record "FA Tracking Specification" temporary; LineIsDemand: Boolean; CurrentSignFactor: Integer; ChangeType: Option Insert,Modify,Delete): Integer
    var
        NewQuantity: Decimal;
        LastEntryNo: Integer;
    begin
        ...
        TempGlobalChangedEntrySummary.SetTrackingFilterFromFASpec(TempTrackingSpecificationChanged);
        if not TempGlobalChangedEntrySummary.FindFirst() then begin
            ...
            TempGlobalChangedEntrySummary.CopyTrackingFromFASpec(TempTrackingSpecificationChanged);
            ...
            if TempTrackingSpecificationChanged."Serial No." <> '' then
                TempGlobalChangedEntrySummary."Table ID" := Database::"FA Tracking Specification"; // Not a summary line
        ...
        if TempChangedEntrySummary.HasNonSerialTracking() and not SkipLot then begin
            ...
            if TempGlobalEntrySummary.FindFirst() then begin
                ...
                if TempChangedEntrySummary."Serial No." <> '' then // Mark as summation
                    ...
                    TempGlobalEntrySummary."Table ID" := Database::"FA Tracking Specification";
                TempGlobalEntrySummary."Bin Active" := CurrBinCode <> '';
                UpdateBinContent(TempGlobalEntrySummary);
                TempGlobalEntrySummary.UpdateAvailable();
                TempGlobalEntrySummary.Insert();
    ...
    procedure RefreshTrackingAvailability(var TempTrackingSpecification: Record "FA Tracking Specification" temporary; ShowMessage: Boolean) AvailabilityOK: Boolean
    begin
        AvailabilityOK := RefreshTrackingAvailability(TempTrackingSpecification, true, ShowMessage);
    end;

    internal procedure RefreshTrackingAvailability(var TempTrackingSpecification: Record "FA Tracking Specification" temporary; RecreateGlobalDataSet: Boolean; ShowMessage: Boolean) AvailabilityOK: Boolean
    var
        TrackingSpecification2: Record "FA Tracking Specification";
    ...
    local procedure TransferExpDateFromSummary(var TrackingSpecification: Record "FA Tracking Specification" temporary; var TempEntrySummary: Record "Entry Summary" temporary)
    begin
    ...
    begin
        ...
        TempGlobalReservEntry.SetRange("Source Type", Database::"FA Item Journal Line");
    ...
    procedure SumUpTempTrkgSpec(var TempTrackingSpecification: Record "FA Tracking Specification" temporary; ReservEntry: Record "FA Reservation Entry")
    var
    ...
    procedure RelateJnlLineToTempTrkgSpec(var ReservEntry: Record "FA Reservation Entry"; var TempTrackingSpecification: Record "FA Tracking Specification" temporary)
    var
    ...
    begin
        ...
        ReservEntry.TestField("Source Type", Database::"FA Item Journal Line");
    ...
    local procedure FindRelatedParentTrkgSpec(ItemJnlLine: Record "FA Item Journal Line"; var TempTrackingSpecification: Record "FA Tracking Specification" temporary; ItemTrackingSetup: Record "Item Tracking Setup"): Boolean
    begin
    ...
    local procedure AddToAdjustmentEntryDataSet(var ReservEntry: Record "FA Reservation Entry"; AdjustQty: Decimal)
    begin
        if AdjustQty = 0 then
            exit;
    ...
    local procedure MaxDoubleEntryAdjustQty(var TempItemTrackLineChanged: Record "FA Tracking Specification" temporary; var ChangedEntrySummary: Record "Entry Summary" temporary): Decimal
    var
        ItemJnlLine: Record "FA Item Journal Line";
        ItemTrackingSetup: Record "Item Tracking Setup";
    begin
        if not (TempItemTrackLineChanged."Source Type" = Database::"FA Item Journal Line") then
            exit;
    ...
    procedure FindLotNoBySN(TrackingSpecification: Record "FA Tracking Specification"): Code[50]
    var
        LotNo: Code[50];
    begin
    ...
    procedure FindLotNoBySNSilent(var LotNo: Code[50]; TrackingSpecification: Record "FA Tracking Specification"): Boolean
    begin
        Clear(LotNo);
        if not (PartialGlobalDataSetExists or FullGlobalDataSetExists) then
    ...
    procedure FindPackageNoBySN(TrackingSpecification: Record "FA Tracking Specification"): Code[50]
    var
        PackageNo: Code[50];
    begin
    ...
    procedure FindPackageNoBySNSilent(var PackageNo: Code[50]; TrackingSpecification: Record "FA Tracking Specification"): Boolean
    begin
        Clear(PackageNo);
        if not (PartialGlobalDataSetExists or FullGlobalDataSetExists) then
            RetrieveLookupData(TrackingSpecification, true);
    ...
    procedure GetAvailableLotQty(TrackingSpecification: Record "FA Tracking Specification"): Decimal
    begin
    ...
    local procedure CanIncludeReservEntryToTrackingSpec(TempReservEntry: Record "FA Reservation Entry" temporary) Result: Boolean
    var
    ...
    [IntegrationEvent(false, false)]
    local procedure OnLookupTrackingAvailabilityOnSetFiltersElseCase(var TempGlobalEntrySummary: Record "Entry Summary" temporary; var TempGlobalReservEntry: Record "FA Reservation Entry" temporary; TempTrackingSpecification: Record "FA Tracking Specification" temporary; var ItemTrackingSummaryPage: Page "FA Item Tracking Summary"; LookupMode: Enum "Item Tracking Type")
    begin
    end;
