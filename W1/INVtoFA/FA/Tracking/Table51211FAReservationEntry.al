...
table 51211 "FA Reservation Entry"
{
    Caption = 'FA Reservation Entry';
    DrillDownPageID = "FA Reservation Entries";
    LookupPageID = "FA Reservation Entries";
    ...
    fields
    {
        ...
        field(9; "Transferred from Entry No."; Integer)
        {
            ...
            TableRelation = "FA Reservation Entry";
        }
...
#pragma warning restore AS0038
    ...
    begin
        ...
        case "Source Type" of
            ...
            Database::"FA Conversion Header":
                exit(Enum::"Reservation Summary Type"::"FA Conversion Order Header".AsInteger() + "Source Subtype");
            else
                exit(0);
        end;
    end;

    procedure HasSamePointer(var ReservEntry: Record "FA Reservation Entry"): Boolean
    begin
        exit(
    ...
    procedure HasSamePointerWithSpec(var TrackingSpecification: Record "FA Tracking Specification"): Boolean
    begin
        exit(
    ...
    procedure HasSameTracking(ReservEntry: Record "FA Reservation Entry") IsSameTracking: Boolean
    begin
    ...
    procedure HasSameTrackingWithSpec(TrackingSpecification: Record "FA Tracking Specification") IsSameTracking: Boolean
    begin
    ...
    procedure HasSameNewTracking(ReservEntry: Record "FA Reservation Entry") IsSameTracking: Boolean
    begin
    ...
    procedure SetSourceFilterFromReservEntry(ReservEntry: Record "FA Reservation Entry")
    begin
    ...
    procedure Lock()
    var
        Rec2: Record "FA Reservation Entry";
    begin
    ...
    procedure CopyTrackingFromReservEntry(ReservationEntry: Record "FA Reservation Entry")
    begin
    ...
    procedure CopyTrackingFromReservEntryNewTracking(ReservationEntry: Record "FA Reservation Entry")
    begin
    ...
    procedure CopyNewTrackingFromItemJnlLine(ItemJnlLine: Record "FA Item Journal Line")
    begin
    ...
    procedure CopyNewTrackingFromReservEntry(ReservEntry: Record "FA Reservation Entry")
    begin
    ...
    procedure CopyTrackingFiltersToReservEntry(var FilterReservEntry: Record "FA Reservation Entry")
    begin
    ...
    procedure SetTrackingFilterFromItemJnlLine(ItemJournalLine: Record "FA Item Journal Line")
    begin
    ...
    procedure CopyTrackingFilterFromItemLedgEntry(var ItemLedgEntry: Record "FA Item Ledger Entry")
    begin
    ...
    procedure SetTrackingFilterFromSpecIfNotBlank(TrackingSpecification: Record "FA Tracking Specification")
    begin
    ...
    procedure SetTrackingFilterFromTrackingSpecIfNotBlank(TrackingSpecification: Record "FA Tracking Specification")
    begin
        if TrackingSpecification."Serial No." <> '' then
            SetRange("Serial No.", TrackingSpecification."Serial No.")
        else
    ...
    procedure SetTrackingFilterToItemIfRequired(var Item: Record "FA Item")
    begin
        if "Lot No." <> '' then
    ...
    procedure UpdateActionMessageEntries(OldReservEntry: Record "FA Reservation Entry")
    var
        ActionMessageEntry: Record "Action Message Entry";
    ...
    begin
        if OldReservEntry."Reservation Status" = OldReservEntry."Reservation Status"::Surplus then begin
            ActionMessageEntry.FilterFromFAReservEntry(OldReservEntry);
            if ActionMessageEntry.FindSet() then
                repeat
                    ActionMessageEntry2 := ActionMessageEntry;
                    ActionMessageEntry2.TransferFromFAReservEntry(Rec);
    ...
    procedure TransferReservations(var OldReservEntry: Record "FA Reservation Entry"; ItemNo: Code[20]; VariantCode: Code[10]; LocationCode: Code[10]; TransferAll: Boolean; TransferQty: Decimal; QtyPerUOM: Decimal; SourceType: Integer; SourceSubtype: Option; SourceID: Code[20]; SourceBatchName: Code[10]; SourceProdOrderLine: Integer; SourceRefNo: Integer)
    var
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterSetTrackingFilterToItemIfRequired(ReservationEntry: Record "FA Reservation Entry"; var Item: Record "FA Item")
    begin
    end;
