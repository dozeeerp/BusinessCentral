...
page 51223 "FA Item Tracking Entries"
{
        ...
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Serial No."; Rec."Serial No.")
                {
                    ...
                    begin
                        ItemTrackingManagement.LookupTrackingNoInfo(
                            Rec."FA Item No.", '', "Item Tracking Type"::"Serial No.", Rec."Serial No.");
                    end;
                }
                field("Lot No."; Rec."Lot No.")
                {
                    ...
                    begin
                        ItemTrackingManagement.LookupTrackingNoInfo(
                            Rec."FA Item No.", '', "Item Tracking Type"::"Lot No.", Rec."Lot No.");
                    end;
                }
            ...
            group("&Item Tracking Entry")
            {
                ...
                action("Serial No. Information Card")
                {
                    ...
                    begin
                        ...
                        TrackingSpecification.SetItemData(Rec."FA Item No.", '', Rec."Location Code", '', '', 0);
